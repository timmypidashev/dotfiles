...
call plug#begin()
    ...
    Plug 'https://github.com/kyazdani42/nvim-web-devicons' " terminal icons
    Plug 'https://github.com/projekt0n/github-nvim-theme' " github colortheme
    Plug 'https://github.com/nvim-lualine/lualine.nvim' " lualine
    Plug 'https://github.com/glepnir/dashboard-nvim' " dashboard
    Plug 'https://github.com/junegunn/fzf.vim' " fzf(required by dashboard)
    Plug 'https://github.com/projekt0n/circles.nvim' " filetype circle colors
...
" ---------------
" dashboard config TODO: Finish dashboard setup
" ---------------
"  set default fuzzy search
